...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 29 11:39:56 2018
...
path = '/home/karan/Karan/anaconda-workspace/python3-wokspace/CMPT733/My project folder/combined-data-unclean/combined-data-4-sources/MKBHD/part-00000' 

ng = nGram(n=2, corpus_file=path, cache=False)
print(ng.sentence_probability(sentence='bacon', n=1, form='antilog'))